...
void setup() {
  ...
  int t2 = 0;
  while (t2 < numberOfFrames2) {
    gif2[t2] = loadImage("frame_0"+t2+"_delay-0.03s.gif");
    t2 = t2+1;
  }
  ...
  myButtons[4] = new Button(600, 400, 300, 200);
  myButtons[5] = new Button(600, 650, 300, 200);
}
